    ...
    return (
        <>
            <div className={`${theme ? 'bg-black text-white' : 'bg-white text-black'} px-6 shadow-md flex justify-between items-center w-full h-20`}>
                ...
                <input value={search} onChange={(e) => { setSearch(e.target.value) }} className="w-1/2 border px-2 md:px-5 py-1.5 md:py-3 rounded-full" type="text" placeholder="Search Country by name..." />
